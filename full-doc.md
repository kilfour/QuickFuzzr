...
| Method| Description |
| -| - |
| [ExtFuzzr.Apply(this FuzzrOf&lt;T&gt; fuzzr, Action&lt;T&gt; action)](#extfuzzrapplythis-fuzzroft-fuzzr,-actiont-action)| Executes a side-effect for, or transform each value generated by the wrapped fuzzr. |
| [ExtFuzzr.AsObject(this FuzzrOf&lt;T&gt; fuzzr)](#extfuzzrasobjectthis-fuzzroft-fuzzr)| Boxes generated values as `object` without modifying them. |
| [ExtFuzzr.Many(this FuzzrOf&lt;T&gt; fuzzr, int number)](#extfuzzrmanythis-fuzzroft-fuzzr,-int-number)| Produces a number of values from the wrapped fuzzr. |
| [ExtFuzzr.NeverReturnNull(this FuzzrOf&lt;T?&gt; fuzzr)](#extfuzzrneverreturnnullthis-fuzzroft?-fuzzr)| Filters out null values, retrying until a non-null value is produced or the retry limit is exceeded. |
| [ExtFuzzr.Nullable(this FuzzrOf&lt;T&gt; fuzzr)](#extfuzzrnullablethis-fuzzroft-fuzzr)| Converts a non-nullable value-type fuzzr into a nullable one with a default 20% null probability. |
| [ExtFuzzr.NullableRef(this FuzzrOf<T> fuzzr)](#extfuzzrnullablerefthis-fuzzroft-fuzzr)| Wraps a reference-type fuzzr to sometimes return null (default 20% chance). |
| [ExtFuzzr.Shuffle&lt;T&gt;(this FuzzrOf&lt;IEnumerable&lt;T&gt;&gt; source)](#extfuzzrshuffletthis-fuzzrofienumerablet-source)| Randomly shuffles the sequence produced by the source fuzzr. |
| [ExtFuzzr.Unique&lt;T&gt;(this FuzzrOf&lt;T&gt; fuzzr, object key)](#extfuzzruniquetthis-fuzzroft-fuzzr,-object-key)| Ensures all generated values are unique within the given key scope. |
| [ExtFuzzr.Where(this FuzzrOf&lt;T&gt; fuzzr, Func&lt;T,bool&gt; predicate)](#extfuzzrwherethis-fuzzroft-fuzzr,-funct,bool-predicate)| Filters generated values so only values satisfying the predicate are returned. |
| [ExtFuzzr.WithDefault(this FuzzrOf&lt;T&gt; fuzzr, T def = default)](#extfuzzrwithdefaultthis-fuzzroft-fuzzr,-t-def-=-default)| Returns def instead of throwing when the underlying fuzzr fails due to empty choices. |
