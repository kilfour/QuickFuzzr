...
namespace QuickFuzzr.Tests.Docs.B_Reference.P_Primitives.A_Ranged.Continuous;
...
[DocContent("- The overload `Fuzzr.Decimal(decimal min, decimal max)` generates a decimal in the range [min, max) (min inclusive, max exclusive).")]
