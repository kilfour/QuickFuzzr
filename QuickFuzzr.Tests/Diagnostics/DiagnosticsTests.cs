// using QuickFuzzr.Diagnostics;
// using QuickFuzzr.Diagnostics.Inspectors;


// namespace QuickFuzzr.Tests.Diagnostics;

// [DiagnosticsInspecting(
// 	Content =
// @"QuickFuzzr allows you to inspect generated values through use of the `Inspect<T>(...)` combinator:
// ```
