...
{
	/// <summary>
	/// Creates a generator that produces random TimeSpan values between 1 and 1000 ticks.
	...
	/// <summary>
	/// Creates a generator that produces random TimeSpan values between 1 and the specified maximum number of ticks (exclusive).
