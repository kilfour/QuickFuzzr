...
{
	/// <summary>
	/// Creates a generator that produces random double-precision floating-point values between 1 (inclusive) and 100 (exclusive).
	...
	/// <summary>
	/// Creates a generator that produces random double-precision floating-point values within the specified range [min, max).
