...
{
	/// <summary>
	/// Creates a generator that produces random strings of lowercase letters with length between 1 and 10 characters.
	...
	/// <summary>
	/// Creates a generator that produces random strings of lowercase letters with exactly the specified length.
	...
	/// <summary>
	/// Creates a generator that produces random strings of lowercase letters with length between the specified min and max (inclusive).
	...
	/// <summary>
	/// Creates a generator that produces random strings using the specified character generator with length between 1 and 10 characters.
	...
	/// <summary>
	/// Creates a generator that produces random strings using the specified character generator with exactly the specified length.
	...
	/// <summary>
	/// Creates a generator that produces random strings using the specified character generator with length between min and max (inclusive).
