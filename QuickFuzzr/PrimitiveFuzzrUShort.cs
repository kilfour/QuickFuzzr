...
{
	/// <summary>
	/// Creates a generator that produces random unsigned short integer values between 1 (inclusive) and 100 (exclusive).
	...
	/// <summary>
	/// Creates a generator that produces random unsigned short integer values within the specified range [min, max).
