...
{
	/// <summary>
	/// Creates a generator that produces random decimal values between 1 (inclusive) and 100 (exclusive) with 2 decimal places.
	...
	/// <summary>
	/// Creates a generator that produces random decimal values between 1 (inclusive) and 100 (exclusive) with specified precision.
	...
	/// <summary>
	/// Creates a generator that produces random decimal values within the specified range [min, max) with controlled precision.
